...
import dev.jonkursani.restapigr1.exceptions.book.BookNotFoundException;
...
public class BookController {
    ...
    // @QueryParameters
    // /api/books
    @Operation(summary = "Get all books", description = "Endpoint to get all books from list")
    @ResponseStatus(HttpStatus.OK) // 200
    @GetMapping // ?category=science
    public List<Book> getBooks(
            @Parameter(description = "Optional category of the book you want to retrieve")
...
//    }
    ...
    @Operation(summary = "Get by id", description = "Endpoint to get book by id from list")
    @ResponseStatus(HttpStatus.OK) // 200
    @GetMapping("/{id}")
...
//                .orElse(null);
    ...
    @Operation(summary = "Create book", description = "Endpoint to create new book")
...
//        );
    ...
    @Operation(summary = "Update book", description = "Endpoint to update existing book by id")
    ...
    @Operation(summary = "Delete book", description = "Endpoint to delete existing book by id")
    @ResponseStatus(HttpStatus.NO_CONTENT) // 204
    @DeleteMapping("/{id}")
